...
文档面向需要接入木瓜 API 的开发者，覆盖平台介绍、快速接入、鉴权安全、SDK 调用、工具配置、API 参考和常见问题。

## 文档内容

- 使用指南：平台介绍、接入地址、快速开始、鉴权与安全、SDK 配置、额度与计费
- 配置管理工具：CC Switch、AIO Coding Hub
- 命令行工具：Claude Code、Codex、OpenCode、OpenClaw
- 客户端配置：Cherry Studio
- API 参考：接口协议对照、模型列表、聊天补全、Responses API、Anthropic Messages、流式输出、错误处理
- 帮助内容：常见问题和排查建议
